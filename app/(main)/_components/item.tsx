...
export const Item = ({
  ...
  return (
    ...
    >
      ...
      {isSearch && (
        <kbd className="ml-auto pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded-md border bg-muted px-1.5 font-mono text-[12px] font-semibold text-muted-foreground opacity-100">
          <span>
            <Command size={12} />
          </span>
          K
